...
export default function Page() {
	...
	return (
		<main className="min-h-screen bg-gray-50">
			{/* Gallery (heading added and top margin) */}
			<section className="max-w-7xl mx-auto px-4 pt-28  pb-8">
				<div className="mb-6">
					<h1 className="text-3xl md:text-4xl font-bold">Customise Projects</h1>
				</div>

								{/* Large attractive 3-column layout on md+ with generous gap */}
												...
												>
													...
													<div className="absolute inset-0 flex items-end p-4 pointer-events-none">
														<div className="w-full flex items-center justify-between text-white opacity-0 group-hover:opacity-100 transition">
															<div>
																<div className="text-sm font-semibold drop-shadow">Customized Project</div>
				...
				<div className="fixed inset-0 z-50 flex items-center justify-center">
					...
					<div className="relative max-w-[90vw] max-h-[90vh]">
						...
						<img
							...
							alt={`Customized project ${lightboxIndex + 1}`}
