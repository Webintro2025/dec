					...
					<div className="lg:col-span-1">
						...
						<div className="space-y-4">
							<div className="flex items-start space-x-3">
								...
								<div>
									<p className="text-black font-medium">+91 8821904444</p>
					...
					<div>
						...
						<div className="space-y-4">
							...
							<div className="flex space-x-4 pt-4">
								...
								<a href="https://www.facebook.com/share/1Nfsk6v6A2/?mibextid=wwXIfr" className="w-10 h-10 bg-white/10 hover:bg-amber-600 rounded-full flex items-center justify-center transition-colors duration-300 group" aria-label="Facebook">
									<svg className="w-5 h-5 text-black group-hover:text-black" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
										<circle cx="12" cy="12" r="11" />
										<path d="M13 8h1.5a1 1 0 000-2H13a3 3 0 00-3 3v2H8.5a1 1 0 100 2H10v5a1 1 0 001 1h2a1 1 0 001-1v-5h1.5a1 1 0 100-2H14v-2a1 1 0 011-1z" />
									</svg>
								</a>
